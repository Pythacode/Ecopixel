...
class Tuto() :
    def __init__(self, advencement):
        ...
        self.messages = {
            "present" : f"Bienvenu sur Écopixel.\nNous allons te guider pas à pas pour que tu apprennes à jouer. Si tu es bloqué·e, appuie sur la touche {pygame.key.name(main_game.key_help)}.",
            ...
            "recolte" : f"Attend que des fruits tombe d'un arbre, puis récolte le en passant dessus.",
            "buy" : f"Vas devant le shop et appuie sur {pygame.key.name(main_game.key_action)}, vend tes fruits et achète de l'engrais",
